...
import br.com.munif.alunos.application.service.CursoService;
...
public class CursoAPI extends GumgaAPI<Curso, Long> {


    @Autowired
    public CursoAPI(GumgaService<Curso, Long> service) {
        super(service);
    }
